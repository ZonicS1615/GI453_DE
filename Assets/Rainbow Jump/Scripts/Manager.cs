...
namespace RainbowJump.Scripts
{
    public class Manager : MonoBehaviour
    {
        ...
        private int CountToPlay = 0;
        private int CountBuyingItem = 0;
        ...
        void Update()
        {
            if (gameOver == true)
            {
                ...
                CountToPlay++;
                CustomEvent exampleEvent = new CustomEvent("GameplayData")
                {
                    {"userScore", (int)score},
                ...
                CountBuyingItem++;
                CustomEvent BuyingEvent = new CustomEvent("BuyItems")
                {
                    {"itemName",itemName},
                    {"CountBuyingItem",CountBuyingItem},
                };
                AnalyticsService.Instance.RecordEvent(exampleEvent);
